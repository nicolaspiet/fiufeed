        ...
        return (
          <div
            ...
            style={{
              ...
              background: isWinner ? 'color-mix(in srgb, #10b981 12%, var(--bg) 88%)' : 'transparent',
            }}
          >
            <div className="flex items-start gap-3">
              <div className="mt-1 w-7 flex-shrink-0 text-center">
                {isWinner ? (
                  ...
                  <span className="text-sm font-bold" style={{ color: 'var(--text-faint)' }}>{index + 1}</span>
                )}
              </div>
